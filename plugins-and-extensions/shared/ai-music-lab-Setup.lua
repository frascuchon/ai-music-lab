-- @description AI Music Lab - Setup (deprecated, merged into AI Music Lab)
-- @version 2.0
-- @author AI Music Lab
-- @about DEPRECATED: the global setup wizard is now the "Setup" tab inside
...
_G.AI_MUSIC_LAB_INITIAL_TAB = "Setup"
