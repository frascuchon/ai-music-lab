-- @description AI Music Lab - MidiGenerator (deprecated, merged into AI Music Lab)
-- @version 2.0
-- @author AI Music Lab
-- @about DEPRECATED: MidiGenerator is now the "MidiGenerator" tab inside the
...
_G.AI_MUSIC_LAB_INITIAL_TAB = "MidiGenerator"
